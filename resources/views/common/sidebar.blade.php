<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul id="accordion" class="accordion">
        ...
        <li>
            <div class="link"><a href="{{route('memberManage')}}"><i class="fa fa-code"></i>Member Manage </a></div>
        </li>
        ...
        <li>
            <div class="link"><a href="{{route('productrateManage')}}"><i class="fa fa-code"></i>Product Rate Manage </a>
            </div>
        </li>
