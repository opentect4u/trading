    ...
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                ...
                <div class="titleSec">
                    <h2>{{isset($data)?'View':'Create'}} Bank Voucher</h2>
                </div>

                <div class="row">
                    <div class="col-sm-12">
                        <form method="POST"
                            action="{{isset($data)?route('bankvoucherUpdate'):route('bankvoucherCreate')}}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <label for="">Voucher mode : BANK</label>
                            ...
                            <div class="form-group row">
                                ...
                                @if(isset($data))
                                <input type="text" name="dr_cr_flag_1" id="dr_cr_flag_1"
                                    value="{{$data[0]['dr_cr_flag']}}" hidden>
                                <input type="text" name="acc_head_id" id="acc_head_id"
                                    value="{{$data[0]['acc_head_id']}}" hidden>
                                @endif
                                <div class="col-sm-12">
...
<script>
toastr.success('Bank voucher update successfully.');
</script>
@endif
